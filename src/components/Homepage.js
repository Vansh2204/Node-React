                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <h3 style={color}>MongoDB Database</h3>
                            <p style={color}>MongoDB is a versatile and feature-rich database that is well-suited for a wide range of applications, including web and mobile applications, content management systems, real-time analytics, and more. Its flexible data model, scalability, and performance make it a popular choice for modern applications that require dynamic and evolving data structures</p>
                        </div>
                        <div class="col-md-4">
                            ...
                            <h3 style={color}>React JS</h3>
                            <p style={color}>React's component-based architecture, virtual DOM, declarative syntax, and rich ecosystem make it a powerful and flexible library for building modern web applications with dynamic and interactive user interfaces.</p>
                        </div>
                    </div>
                </div>
            </section>
