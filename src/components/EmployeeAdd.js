        ...
        <>
            <div class="container border border-dark mt-3" style={{ backgroundColor: "black" }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" value={employee.ApplicationDate} class="form-control " id="exampleFormControlInput1" placeholder="YYYY-MM-DD" onChange={(e) => { setemployee({ ...employee, ApplicationDate: e.target.value }) }} />
                </div>
                <div class="mb-3">
