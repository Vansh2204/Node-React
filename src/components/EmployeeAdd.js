    ...
    return (
        <>
            <div class="container border border-dark">
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label" style={{ color: "black" }}><span class="badge text-bg-secondary">Application Name</span></label>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label" style={{ color: "black" }}><span class="badge text-bg-secondary">Position Applied For</span></label>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label" style={{ color: "black" }}><span class="badge text-bg-secondary">Application Date</span></label>
                ...
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label " style={{ color: "black" }}><span class="badge text-bg-secondary">Status </span></label>
